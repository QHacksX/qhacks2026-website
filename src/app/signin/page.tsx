    ...
    <div className="relative h-screen overflow-hidden">
        ...
        <div className=" absolute inset-0 bg-gradient-to-b from-[#020202] to-[#2B2929] flex justify-center items-center px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative w-full max-w-md sm:max-w-lg lg:max-w-xl">
                <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-[#E3C676] text-center">Sign In</h1>
                <form onSubmit={handleForm} className="lg:mt-12 space-y-6 sm:space-y-8">

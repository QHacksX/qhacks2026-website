...
const HorizontalScroll = ({ children, enabled = true }: HorizontalScrollProps) => {
  ...
  return (
    <div ref={containerRef} className="relative h-screen overflow-hidden" style={{ height: `${children.length * 100}vh` }}>
      <div className="sticky top-0 h-screen overflow-hidden">
        <motion.div ref={scrollerRef} style={{ x: smoothX }} className="flex h-full w-max">
